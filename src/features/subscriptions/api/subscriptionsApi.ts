...
let mockSubscriptions: Subscription[] = [
  ...
  // Assinaturas do customer ID 2
  {
    ...
    interval: 'monthly',
    status: 'active',
    nextDelivery: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    startDate: new Date(Date.now() - 90 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    paymentMethod: 'Cartão de Crédito **** 5678',
    shippingAddress: {
      street: 'Av. Paulista',
      number: '1500',
      complement: 'Casa 2',
  ...
  },
  {
    ...
    customerName: 'Maria Santos',
    productId: '8',
    productName: 'Petiscos Natural Bife Desidratado',
    quantity: 3,
    price: 15.90,
    interval: 'weekly',
    status: 'paused',
    nextDelivery: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    startDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    paymentMethod: 'Cartão de Crédito **** 5678',
    shippingAddress: {
      street: 'Av. Paulista',
    ...
    notes: 'Pausada temporariamente - viagem',
    createdAt: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString(),
